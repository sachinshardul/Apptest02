...
define( "RECIPIENT_NAME", "Sachin Shardul" );
define( "RECIPIENT_EMAIL", "sachinshardul@s3dstudios.com" );
define( "EMAIL_SUBJECT", "MT Visitor Message" );
...
<div data-role="page" id="contactResult">
	<div data-role="header"  data-position="fixed">
		<img src="images/MT_Logo.png" width="100%" alt="Logo">
	</div>
...
<li><a href="#contact" class="ui-btn-active ui-statepersist">
Contact Us</a></li>
</ul>
</div>
</div>
